  ...
  return (
    // box-shadow: 10px 5px 5px red;
     <div className="w-full  ">
      <div className=" w-full flex justify-around items-center relative top-0 z-10">
       ...
       <ul className="flex w-[500px] justify-between items-center text-[1.7rem] font-[500] text-[#ffffff] ">
        <li className="cursor-pointer hover:shadow-  hover:shadow-[lightgray] px-4 rounded-full hover:bg-[#1BC76890]  hover:scale-110 ">Home</li>
        <li className="cursor-pointer hover:shadow-[4px_3px_7px] hover:shadow-[lightgray] px-4 rounded-full hover:bg-[#1BC76890] hover:scale-110 ">Products</li>
