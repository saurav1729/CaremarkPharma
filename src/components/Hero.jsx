...
const Hero = () => {
  ...
  return (
    <div className="pt-16 pb-12 sm:pt-22 md:pt-20 md:pb-16 w-full bg-gradient-to-r from-blue-50 via-sky-50 to-teal-50 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="flex flex-col-reverse lg:flex-row items-center text-center md:text-left justify-between w-[92%] lg:w-[100%] max-w-[90%] mx-auto gap-8 lg:gap-12 mt-6 md:mt-8 lg:mt-20">
        ...
        >
          ...
          >
            ...
            <motion.p 
              className="text-lg text-gray-600 mb-8 max-w-md text-center md:text-left"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          >
            <h3 className="text-[#293649] font-semibold mb-4 text-center md:text-left">Why Choose Us</h3>
            <motion.ul 
