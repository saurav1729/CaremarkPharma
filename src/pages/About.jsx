...
import CompanyLeadership from "../components/CompanyLeadership"
              ...
              <div className="p-8 md:p-10">
                ...
                <div className="space-y-6 text-gray-600">
                  <p className="text-lg text-justify">
                    Established in 2021, Caremark Pharmaceutical is a growing pharmaceutical company focused on delivering high-quality products for the healthcare sector. Driven by a strong commitment to quality, safety, and continuous improvement, we aim to support healthcare needs through reliable and effective pharmaceutical solutions. Based in India, Caremark Pharmaceutical is steadily expanding its presence while maintaining a customer-centric approach and adherence to industry standards.
                  </p>
                  ...
                  {/* <div className="mt-8 pt-8 border-t border-gray-100">
                    ...
                    <ul className="space-y-3">
                      <li className="flex items-center">
                        ...
                        <span>Pharmaceutical & Healthcare Products</span>
                      </li>
                      <li className="flex items-center">
  ...
  <div>
    <h3 className="text-xl font-semibold text-[#293649] mb-4">
      Company Details
    </h3>
    <ul className="space-y-3">
      <li className="flex items-center">
